...
<body>
    <div class="adsoyad">
        <h3>Sn.<?php echo $kullanicicek['kullanici_adsoyad']?></h3>
    </div>
...
<select name="hastane" class="hastane">
    ...
    <option value="Medicana Hastanesi" >Medicana Hastanesi</option>
</select>
<select name="klinik" class="klinik">
    <option value="kilinik" >Klinik Seçiniz</option>
...
<select name="doktor" class="doktor">
    ...
    <option value="Kübra Demetgül" >Kübra Demetgül</option>
    <option value="Sena Yiğit" >Sena Yiğit</option>
    <option value="Büşra Vural" >Büşra Vural</option>
    <option value="Tuğçe Şahin" >Tuğçe Şahin</option></option>
</select>
...
<button name="randevu_kaydet">Randevu Kaydet</button>
    ...
    <div class=orta_div id="ailehekimi_div">
        <h3>Aile Hekimi</h3>
        <p>Aile Hekiminize Ait Çalışma Saati Bulunmamaktadır.</p>
    </div>
</body>
</html>
